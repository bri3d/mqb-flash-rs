...
const FRF_S1810: &str =
    concat!(env!("CARGO_MANIFEST_DIR"), "/../../../frf/FL_5G0906259Q__0005.frf");
const FRF_S18_H1: &str =
    concat!(env!("CARGO_MANIFEST_DIR"), "/../../../frf/FL_8V0906259H__0001.frf");
const FRF_S18_H2: &str =
    concat!(env!("CARGO_MANIFEST_DIR"), "/../../../frf/FL_8V0906259H__0002.frf");
const FRF_S18_A3: &str =
    concat!(env!("CARGO_MANIFEST_DIR"), "/../../../frf/FL_8V0906259A__0003.frf");
const FRF_S18_A4: &str =
    concat!(env!("CARGO_MANIFEST_DIR"), "/../../../frf/FL_8V0906259A__0004.frf");
const FRF_S18_E2: &str =
    concat!(env!("CARGO_MANIFEST_DIR"), "/../../../frf/FL_8V0906259E__0002.frf");
const FRF_S18_J3: &str =
    concat!(env!("CARGO_MANIFEST_DIR"), "/../../../frf/FL_8V0906259J__0003.frf");
const FRF_S18_K3: &str =
...
fn extract_frf_to_bin(frf_path: &str, flash_info: &'static FlashInfo) -> Vec<u8> {
    ...
    let blocks: HashMap<String, BlockData> = raw
        .into_iter()
        .map(|(num, bytes)| {
            let name = flash_info.block_number_to_name(num).unwrap_or("UNKNOWN").to_owned();
...
fn assert_all_valid(frf_path: &str, flash_info: &'static FlashInfo) {
    ...
    let by_num: HashMap<u8, &BlockData> =
        by_name.values().map(|b| (b.block_number, b)).collect();
