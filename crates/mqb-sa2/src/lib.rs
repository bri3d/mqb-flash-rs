...
mod tests {
    ...
    fn sa2_simos1810_vector() {
        ...
        let script = [
            0x68u8, 0x03, 0x81, 0x4A, 0x10, 0x68, 0x02, 0x93, 0x05, 0x05, 0x20, 0x15, 0x4A,
            0x05, 0x87, 0x22, 0x12, 0x19, 0x54, 0x82, 0x49, 0x93, 0xF4, 0x23, 0xBF, 0x7D, 0x82,
            0x4A, 0x05, 0x87, 0x5A, 0x63, 0xFC, 0x5E, 0x82, 0x4A, 0x01, 0x81, 0x49, 0x4C,
        ];
