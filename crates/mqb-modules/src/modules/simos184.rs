...
static S184_CRYPTO: AesCrypto = AesCrypto::new(
    [
        0x6E, 0x3F, 0xE0, 0x36, 0x19, 0xF1, 0x38, 0x79, 0x8C, 0xB4, 0xEC, 0xDC, 0xC7, 0x62, 0x00,
        0x5F,
    ],
    [
...
const SA2_SCRIPT: &[u8] = &[
    0x68, 0x02, 0x81, 0x4A, 0x10, 0x68, 0x04, 0x93, 0xC1, 0x38, 0x7F, 0xA3, 0x4A, 0x05, 0x87, 0x22,
    0x12, 0x19, 0x54, 0x82, 0x49, 0x93, 0x18, 0x10, 0x20, 0x12, 0x82, 0x4A, 0x05, 0x87, 0x28, 0x05,
...
fn s184_transfer_size_patch(block_num: u8, address: usize) -> usize {
    assert_eq!(
        block_num, 2,
        "Only Block 2 (ASW1) patching is supported for Simos18.41"
    );
    if address < 0x68500 {
        return 0x100;
    }
