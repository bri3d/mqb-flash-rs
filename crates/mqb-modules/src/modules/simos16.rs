...
static S16_CRYPTO: AesCrypto = AesCrypto::new(
    [0x0A, 0xCF, 0xFB, 0x51, 0x3E, 0x95, 0x64, 0x4A, 0x39, 0x6A, 0x41, 0x32, 0x52, 0x35, 0xD9, 0xA9],
    [0x01, 0xD1, 0x37, 0x42, 0x6B, 0x6B, 0x53, 0x6F, 0xB3, 0x33, 0x3F, 0x69, 0x1B, 0x36, 0x6D, 0x34],
);

const SA2_SCRIPT: &[u8] = &[
    0x68, 0x03, 0x93, 0x71, 0x2E, 0xAB, 0x7C, 0x4A, 0x05, 0x93, 0x14, 0x06, 0x20, 0x12, 0x49,
    0x68, 0x03, 0x87, 0x01, 0x12, 0x20, 0x12, 0x82, 0x82, 0x4A, 0x05, 0x84, 0xFD, 0x07, 0x3A,
    0x5D, 0x49, 0x4C,
];

const BASE_ADDRESSES: &[(u8, u32)] = &[
    (0, 0x80000000), (1, 0x80020000), (2, 0x80040000),
...
const BINFILE_LAYOUT: &[(u8, usize)] = &[
    (0, 0x000000), (1, 0x020000), (2, 0x040000),
