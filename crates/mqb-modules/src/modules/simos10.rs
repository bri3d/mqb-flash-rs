...
const SA2_SCRIPT: &[u8] = &[
    0x68, 0x03, 0x82, 0x4A, 0x10, 0x68, 0x02, 0x84, 0x44, 0x39, 0x32, 0x24, 0x4A, 0x05, 0x87,
    0x27, 0x09, 0x20, 0x04, 0x81, 0x49, 0x93, 0x84, 0x25, 0x16, 0x48, 0x82, 0x4A, 0x05, 0x87,
    0x12, 0x08, 0x20, 0x01, 0x82, 0x4A, 0x01, 0x81, 0x49, 0x4C,
];

const BASE_ADDRESSES: &[(u8, u32)] = &[
    (1, 0x8000C000), (2, 0x80020000), (3, 0xA01C0000), (6, 0xA01C0000),
];

const BLOCK_LENGTHS: &[(u8, usize)] = &[
    (1, 0x13E00), (2, 0x19FA00), (3, 0x3C000),
];

const BLOCK_NAMES_FRF: &[(u8, &str)] = &[
    (1, "FD_1"), (2, "FD_2"), (3, "FD_3"),
];

const BINFILE_LAYOUT: &[(u8, usize)] = &[
    (1, 0x00C000), (2, 0x020000), (3, 0x1C0000),
];
