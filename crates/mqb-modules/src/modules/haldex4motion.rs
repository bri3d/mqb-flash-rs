...
const BLOCK_IDENTIFIERS: &[(u8, u8)] = &[(1, 0x30), (2, 0x02), (3, 0x01), (4, 0x03)];
...
const BLOCK_TRANSFER_SIZES: &[(u8, usize)] = &[(1, 0x100), (2, 0x100), (3, 0x100), (4, 0x100)];
...
pub static HALDEX_FLASH_INFO: FlashInfo = FlashInfo {
    ...
    encryption_type: 0x00,
    block_prep: BlockPrep::Raw,
    no_erase_max_block: 1,
    uds_checksum_kind: UdsChecksumKind::Crc32Be,
    default_stmin_us: 900,
    no_internal_checksum_blocks: &[1],
};
