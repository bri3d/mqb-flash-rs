...
static S1810_CRYPTO: AesCrypto = AesCrypto::new(
    [0xAE, 0x54, 0x05, 0x02, 0xE4, 0x8E, 0x38, 0x54, 0xDB, 0xCA, 0x1A, 0x15, 0x45, 0xBA, 0x6F, 0x33],
    [0x62, 0xF3, 0x13, 0xFA, 0x5C, 0x08, 0x53, 0x27, 0x98, 0xBC, 0xA4, 0x52, 0x47, 0x1D, 0x20, 0xD5],
);

const SA2_SCRIPT: &[u8] = &[
    0x68, 0x03, 0x81, 0x4A, 0x10, 0x68, 0x02, 0x93, 0x05, 0x05, 0x20, 0x15, 0x4A, 0x05, 0x87,
    0x22, 0x12, 0x19, 0x54, 0x82, 0x49, 0x93, 0xF4, 0x23, 0xBF, 0x7D, 0x82, 0x4A, 0x05, 0x87,
    0x5A, 0x63, 0xFC, 0x5E, 0x82, 0x4A, 0x01, 0x81, 0x49, 0x4C,
];
...
const BLOCK_NAMES_FRF: &[(u8, &str)] = &[
    (1, "FD_01DATA"), (2, "FD_02DATA"), (3, "FD_03DATA"), (4, "FD_04DATA"), (5, "FD_05DATA"),
];
...
fn s1810_transfer_size_patch(block_num: u8, address: usize) -> usize {
    assert_eq!(block_num, 2, "Only Block 2 (ASW1) patching is supported for Simos18.10");
