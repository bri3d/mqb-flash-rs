//! Simos12 ECU flash configuration.
...
static S12_CRYPTO: AesCrypto = AesCrypto::new(
    [0x31, 0x4D, 0x75, 0x36, 0x41, 0x6E, 0x30, 0x47, 0x39, 0x6A, 0x41, 0x32, 0x52, 0x35, 0x6F, 0x45],
    [0x30, 0x6E, 0x37, 0x42, 0x6B, 0x6B, 0x53, 0x6F, 0x31, 0x6D, 0x4A, 0x69, 0x74, 0x36, 0x6D, 0x34],
);

const SA2_SCRIPT: &[u8] = &[
    0x68, 0x03, 0x81, 0x4A, 0x10, 0x68, 0x03, 0x93, 0x29, 0x07, 0x20, 0x09, 0x4A, 0x05, 0x87,
    0x22, 0x12, 0x19, 0x54, 0x82, 0x49, 0x93, 0x09, 0x01, 0x19, 0x53, 0x82, 0x4A, 0x05, 0x87,
    0x30, 0x03, 0x20, 0x09, 0x82, 0x4A, 0x01, 0x81, 0x49, 0x4C,
];

const BASE_ADDRESSES: &[(u8, u32)] = &[
    (0, 0x80000000), (1, 0x80020000), (2, 0x800C0000),
    (3, 0x80180000), (4, 0x80240000), (5, 0xA0040000), (6, 0x80080000),
];

const BLOCK_LENGTHS: &[(u8, usize)] = &[
    (1, 0x1FE00), (2, 0xBFC00), (3, 0xBFC00), (4, 0xBFC00), (5, 0x6FC00), (6, 0x1FE00),
];
...
const BINFILE_LAYOUT: &[(u8, usize)] = &[
    (0, 0x000000), (1, 0x020000), (2, 0x0C0000),
    (3, 0x180000), (4, 0x240000), (5, 0x040000),
];

pub static S12_FLASH_INFO: FlashInfo = FlashInfo {
