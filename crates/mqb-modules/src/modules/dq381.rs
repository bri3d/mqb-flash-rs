...
pub const BLOCK_BASE_ADDRESSES: &[(u8, u32)] = &[(1, 0x010200), (2, 0x030200), (3, 0x140200)];
...
const BLOCK_NAMES_FRF: &[(u8, &str)] = &[(1, "FD_01DATA"), (2, "FD_02DATA"), (3, "FD_03DATA")];

const BLOCK_IDENTIFIERS: &[(u8, u8)] = &[(1, 1), (2, 2), (3, 3)];
...
const BLOCK_TRANSFER_SIZES: &[(u8, usize)] = &[(1, 0xF0), (2, 0xF0), (3, 0xF0)];

const BINFILE_LAYOUT: &[(u8, usize)] = &[(1, 0x010200), (2, 0x030200), (3, 0x140200)];

const BLOCK_NAME_TO_NUMBER: &[(&str, u8)] = &[("BOOT", 1), ("ASW", 2), ("CAL", 3)];
...
pub static DQ381_FLASH_INFO: FlashInfo = FlashInfo {
    ...
    block_prep: BlockPrep::LzssExact,
    no_erase_max_block: 0,
    uds_checksum_kind: UdsChecksumKind::Crc32Be,
